...
$(function(){
   ...
   // scroll down landing page
	...
	$("#signUp").on('click', function(e) {
		...
		var token = $("#signUpForm input[name='_token']").val();
		...
		$.ajax({
			...
			success: function(res) {
				console.log(res);
				if (res.errors) {
					$("#signUpNotify").html(res.errors);
				} else {
					window.location.href = res.url;
					$("#signUpNotify").html(res.success);
					$("#signUpForm [name='username']").val("");
					$("#signUpForm [name='email']").val("");
					$("#signUpForm [name='password']").val("");
					$("#signUpForm [name='confiremd_password']").val("");
				}
			},
		});
	});
	...
	$("#signInBtn").on('click', function(e) {
		...
		var token = $("#signInForm input[name='_token']").val();
		...
		$.ajax({
			...
			success: function(res) {
				console.log(res);
				if (res.errors) {
					$("#signInNotify").html(res.errors);
				} else {
					window.location.href = res.url;
					$("#signInNotify").html(res.success);
					$("#signInForm [name='username']").val("");
					$("#signInForm [name='email']").val("");
					$("#signInForm [name='password']").val("");
					$("#signInForm [name='confiremd_password']").val("");
				}
			},
		});
	});
